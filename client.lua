...
addEventHandler("onClientResourceStart", resourceRoot,
    ...
    function dxbutton()
        ...
        dxDrawImage(772, 430, 139, 123, ":coding/img/8.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        dxDrawImage(597, 430, 139, 123, ":coding/img/11.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        dxDrawImage(428, 430, 138, 121, ":coding/img/12.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        dxDrawImage(772, 272, 137, 120, ":coding/img/13.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        dxDrawImage(599, 271, 137, 124, ":coding/img/14.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
        ...
        dxDrawImage(428, 271, 139, 124, ":coding/img/1.png", 0, 0, 0, tocolor(255, 255, 255, 255), false)
